...
public:
    ...
    void Draw()
    {
        food.Draw();
        snake.Draw();
        DrawText(TextFormat("Score: %i", score), offset - 5, offset + cellSize * cellCount + 10, 30, BLUE);
        DrawText(TextFormat("High Score: %i", highScore), offset + 300, offset + cellSize * cellCount + 10, 30, BLUE);
    }
...
int main()
{
    ...
    InitWindow(2 * offset + cellSize * cellCount, 2 * offset + cellSize * cellCount, "SNAKE GAME IN RETRO THEME");
    SetTargetFPS(60);
...
r
    while (WindowShouldClose() == false)
    {
        ...
        DrawText("SNAKE GAME IN RETRO THEME", offset - 5, 20, 30, darkGreen);
        game.Draw();
